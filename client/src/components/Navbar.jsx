    ...
    <div className="hidden sm:flex items-center gap-8">
       ...
       <NavLink to='/'>Contact</NavLink>
        ...
        <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full">
            <input onChange={(e)=>setSearchQuery(e.target.value)} className="py-1.5 w-full  -primary outline-none placeholder-gray-500" type="text" placeholder="Search products" />
        ...
        (
            <div className='relative group'>
                ...
                <ul className='hidden group-hover:block absolute top-10right-0 bg-white shadow
