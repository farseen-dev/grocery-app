  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* <p className="mt-3 text-sm md:text-base text-center md:text-left text-gray-700 max-w-[500px]">
          Enjoy handpicked groceries delivered to your doorstep, straight from local farms and trusted suppliers.
        </p> */}
